...
import {removeInformationItem} from '@/pages/information/clientInformation-list/service';
import OperationModal from '@/pages/information/clientInformation-list/components/OperationModal';


// const {Paragraph} = Typography;

interface InformationListProps {
  listClientInformationList: StateType;
  dispatch: Dispatch;
  loading: boolean;
}
...
class InformationList extends Component<InformationListProps, InformationListState> {
  ...
  componentDidMount() {
    ...
    // this.setState(state)
    dispatch({
      type: 'listClientInformationList/fetch',
      payload: this.state,
    });
  }
  ...
  //
   ...
   handleSubmit = async (values: InfoItem) => {
    const {dispatch} = this.props;
    await dispatch({
      type: 'listClientInformationList/submit',
      payload: values,
    });
    this.setState({
      visible: false,
  ...
  render() {
    ...
    const {
      listClientInformationList: {list},
      loading,
    } = this.props;
...
export default connect(
  ({
    ...
    listClientInformationList,
    loading: loading.models.listClientInformationList,
  }),
)(InformationList);
